...
const testimonials = [
  {
    name: "Серафима Гумеровна",
    role: "Председатель ЖСК «Весна-22»",
    initials: "СГ",
    content:
      "АДРИНСТРОЙ отремонтировали фасад нашего дома и заменили все стояки ХВС. Работы выполнены качественно, в срок. Документы предоставили в полном объёме.",
  },
  {
    name: "Лариса Николаевна",
    role: "Председатель ЖСК «Весна-37»",
    initials: "ЛН",
    content:
  ...
  {
    name: "Азат Ильдусович",
    role: "Директор ООО «ЖЭК-38»",
    initials: "АИ",
    content:
