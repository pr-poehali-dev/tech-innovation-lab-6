        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              ...
              многоквартирных домов. Работаем с управляющими компаниями, ТСЖ и жилищными кооперативами
          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-6 rounded-xl border border-red-500/20 bg-white/5">
                <div className="text-4xl font-bold text-red-500 mb-2 font-orbitron">{stat.value}</div>
