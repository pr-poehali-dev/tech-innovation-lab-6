    ...
    <nav className="fixed top-0 left-0 right-0 z-[9999] bg-black/95 backdrop-blur-md border-b border-amber-500/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* CTA Button */}
          <div className="hidden md:block">
            <Button className="bg-amber-500 hover:bg-amber-600 text-black font-geist font-bold border-0" onClick={() => window.open("https://max.ru/+78986724453", "_blank")}>Получить смету</Button>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black/98 border-t border-amber-500/30">
              ...
              <div className="px-3 py-2">
                <Button className="w-full bg-amber-500 hover:bg-amber-600 text-black font-geist font-bold border-0" onClick={() => window.open("https://max.ru/+78986724453", "_blank")}>
                  Получить смету
                </Button>
              </div>
            </div>
